		...
		<div className="container">
			...
			<form className="form-control" onSubmit={handleSubmit}>
				...
				<div>
					...
					<p>
						Provide a brief description of this activity, including{" "}
						<strong>materials</strong> you need to have, if it is an{" "}
						<strong>outdoor</strong> or <strong>indoor</strong> game, or any
